Feature: Web table user order feature
  ...
  Scenario Outline: User should be able to place order and order seen in web table
    ...
    Examples: Famous female scientists
      | productType | quantity | customerName      | street   | city   | state   | zipCode | cardType | cardNo           | expDate | expectedName      |
      | MoneyCog    | 2        | Marie Curie       | London S | London | England | 50505   | Visa     | 1111222233334444 | 12/24   | Marie Curie       |
      | Familybea   | 3        | Rosalind Franklin | London S | London | England | 50505   | Visa     | 1111222233334444 | 12/24   | Rosalind Franklin |
      | Screenable  | 4        | List Meitner      | London S | London | England | 50505   | Visa     | 1111222233334444 | 12/24   | List Meitner      |
